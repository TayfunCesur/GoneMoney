...
public class ReportDetails extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for (int i = 0;i<expenseList.size();i++)
        {
            if (expenseList.get(i).isMinus)
            {
                ...
                {
                    case "Food":
                        detail.food_expense += Double.parseDouble(expenseList.get(i).amount);
                        break;
                    case "Cigarette":
                        detail.cigarette_expense  += Double.parseDouble(expenseList.get(i).amount);
                        break;
                    case "Alcohol":
                        detail.alcohol_expense  += Double.parseDouble(expenseList.get(i).amount);
                        break;
                    case "Transportation":
                        detail.transportation_expense  += Double.parseDouble(expenseList.get(i).amount.trim());
                        break;
                    case "Invoice":
                        detail.invoice_expense  += Double.parseDouble(expenseList.get(i).amount);
                        break;
                    case "Home Rent":
                        detail.homerent_expense  += Double.parseDouble(expenseList.get(i).amount);
                        break;
                    case "Other":
                        detail.other_expense  += Double.parseDouble(expenseList.get(i).amount);
                        break;
                }
            ...
            {
                detail.totalincome+=Double.parseDouble(expenseList.get(i).amount);
            }
    ...
    private void generategraph()
    {
        ...
        slice.setValue(Float.parseFloat(String.valueOf(detail.food_expense)));
        ...
        slice.setValue(Float.parseFloat(String.valueOf(detail.cigarette_expense)));
        ...
        slice.setValue(Float.parseFloat(String.valueOf(detail.alcohol_expense)));
        ...
        slice.setValue(Float.parseFloat(String.valueOf(detail.transportation_expense)));
        ...
        slice.setValue(Float.parseFloat(String.valueOf(detail.homerent_expense)));
        ...
        slice.setValue(Float.parseFloat(String.valueOf(detail.invoice_expense)));
        ...
        slice.setValue(Float.parseFloat(String.valueOf(detail.other_expense)));
